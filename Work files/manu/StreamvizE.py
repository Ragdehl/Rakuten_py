...
if navigation == "DataViz - approfondissement":
    ...
    batch_size = 32
    path = os.chdir('C:\\Users\\utilisateur\\Documents\\PROJET RAKUTEN\\images\\image_train')
...
if navigation == "Jeu" :
    os.chdir('C:\\Users\\utilisateur\\Documents\\PROJET RAKUTEN\\images')
    path = os.getcwd() + r'/images/image_train' ########
